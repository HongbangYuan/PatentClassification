...
from cogtemplate.models.base_language_model import TransformerForLM,TransformerModel,GRUForLM,FullyConnectedForLM
...
model = FullyConnectedForLM(n_token=ntokens,embedding_dim=emsize,hidden_size=d_hid,length=128)
